...
*/
	...
	for (Electrodomestico aux : lista) {
	    ...
	    Televisor aux1 = (Televisor)aux;
	    aux1.precioFinal();
	    suma += aux1.getPrecio();
}
     System.out.println("el precio de los televisores es: "+ suma);
	}

Double  suma1 = 0.0; 
	for (Electrodomestico aux : lista) {
	    if(aux.getClass() == Lavadora.class){
	    Lavadora aux1 = (Lavadora)aux;
	    aux1.precioFinal();
	    suma1 += aux1.getPrecio();
}
     System.out.println("la suma de los lavarropas es: " + suma1);
     System.out.println("la suma total de los electrodomésticoes es " + (suma+ suma1));
}
